...
function updateInfo() {
  var welcome = $('#welcome');
   welcome.find('.stats .coins').html(App.currentUser.score);
    welcome.find('.stats .bombs').html(App.currentUser.gem);
...
function showLogin(){
      $('#menuleft').addClass('hidden');
  $('#loginbutton').removeClass('hidden');
}
function showMenu(){
      $('#loginbutton').addClass('hidden');
  $('#menuleft').removeClass('hidden');
}
/*
  Game has ended:
