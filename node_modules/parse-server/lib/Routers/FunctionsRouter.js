            ...
            v: new Promise(function (resolve, reject) {
              ...
              var response = FunctionsRouter.createResponseObject(function (result) {
                try {
                  ...
                  _logger.logger.info('Ran cloud function ' + req.params.functionName + ' for user ' + userString + ' ' + ('with:\n  Input: ' + cleanInput + '\n  Result: ' + cleanResult), {
                    functionName: req.params.functionName,
                    params: params,
                    user: userString
                  });
                ...
                try {
                  _logger.logger.error('Failed running cloud function ' + req.params.functionName + ' for ' + ('user ' + userString + ' with:\n  Input: ' + cleanInput + '\n  Error: ') + JSON.stringify(error), {
                    functionName: req.params.functionName,
                    error: error,
                    params: params,
                    user: userString
